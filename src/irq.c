...
*  47 */
#define IRQ_PIC_MASTER_CONTROL 0x20
#define IRQ_PIC_MASTER_DATA 0x21
#define IRQ_PIC_SLAVE_CONTROL 0xA0
#define IRQ_PIC_SLAVE_DATA 0xA1

void irq_remap(void)
{
    outb(IRQ_PIC_MASTER_CONTROL, 0x11);
    outb(IRQ_PIC_SLAVE_CONTROL, 0x11);
    outb(IRQ_PIC_MASTER_DATA, 0x20);
    outb(IRQ_PIC_SLAVE_DATA, 0x28);
    outb(IRQ_PIC_MASTER_DATA, 0x00);
    outb(IRQ_PIC_SLAVE_DATA, 0x00);
    outb(IRQ_PIC_MASTER_DATA, 0x01);
    outb(IRQ_PIC_SLAVE_DATA, 0x01);
    outb(IRQ_PIC_MASTER_DATA, 0xFF);
    outb(IRQ_PIC_SLAVE_DATA, 0xFF);
}
